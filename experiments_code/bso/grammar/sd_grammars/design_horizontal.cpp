#ifndef BSO_GRAMMAR_DESIGN_HORIZONTAL_CPP
#define BSO_GRAMMAR_DESIGN_HORIZONTAL_CPP
...
class DESIGN_HORIZONTAL;

template <>
bso::structural_design::sd_model grammar::sd_grammar<DESIGN_HORIZONTAL>(
...
#endif // BSO_GRAMMAR_DESIGN_HORIZONTAL_CPP