...
template <>
bso::structural_design::sd_model grammar::sd_grammar<EMPTY_SD_GRAMMAR>(const std::string& fileName)
{
	bool useSurfaceTypeInsteadOfSpaceType
...
template <>
structural_design::sd_model grammar::sd_grammar<EMPTY_SD_GRAMMAR>(const std::string& fileName)
{
	return this->sd_grammar<EMPTY_SD_GRAMMAR>(fileName,true);
}
